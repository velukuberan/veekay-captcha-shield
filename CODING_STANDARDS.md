...
- Load admin assets only on the Veekay Captcha Shield settings page.
...
- Always pass the `veekay-captcha-shield` text domain explicitly.
...
- Keep `languages/veekay-captcha-shield.pot` generated from production source strings rather than editing extracted entries manually.
