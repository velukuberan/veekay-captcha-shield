...
final class WooCommerceLoginFormIntegration
{
    private const CAPTCHA_ACTION = 'woocommerce_login';

    private const FORM_ID = 'woocommerce-login-form';
    ...
    private function effectiveProvider(): EffectiveCaptchaProvider
    {
        ...
        $formSetting = $settings->formSettings()[SupportedForms::WOOCOMMERCE_LOGIN]
    ...
    /**
     * WooCommerce validates its login nonce before this filter runs.
     */
