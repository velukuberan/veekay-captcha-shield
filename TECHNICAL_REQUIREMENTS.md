...
* Use one consistent text domain: `veekay-captcha-shield`.
...
* Maintain the generated translation template at `languages/veekay-captcha-shield.pot`.
...
* translation extraction produces `languages/veekay-captcha-shield.pot`;
